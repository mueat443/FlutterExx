...
import 'package:flutterex/core_network.dart';
...
@JS('sendLanguageToReact')
external void sendLanguageToReact(String language);
...
class _OnBoardingSelectLanguageScreenState
  ...
  void _handleLanguageChange(String newLanguage) {
    setState(() {
      languageCode = newLanguage;
      print('[Flutter] Sending language to React: $languageCode');

      sendLanguageToReact(newLanguage);
    });
  }

  @override
  void initState() {
    // receiveLanguageFromReact = allowInterop((String language) {
    //   print('[Flutter] Received language from React: $language');
    //   setState(() {
    //     languageCode = language;
    //   });
    // });
    CoreNetwork().web();
    CoreNetwork().sendCommand();
    print("CoreNetworkWeb: ");
    setState(() {
      switch (languageCode) {
        case "th":
          trackLang = "Th";
